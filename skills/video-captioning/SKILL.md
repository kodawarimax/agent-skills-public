...
字幕は文字起こし結果ではなく、動画の可読な表示レイヤーとして検査する。SRT/VTT原本を保持し、1字幕は原則2行以内、短すぎる表示や過密な分割を避ける。9:16ではUIや顔を隠さないセーフエリアに置く。

納品前に、字幕なし版・字幕ファイル・焼き込み版を分けて確認する。音声との開始・終了、話者交代、重要語、数字、固有名詞を照合し、音ズレがあれば映像・音声の長さも確認する。
